...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BeagleDefaults/BeagleDefaults.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BeagleScaffold/BeagleScaffold.framework"
